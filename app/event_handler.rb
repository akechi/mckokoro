...
module EventHandler
        ...
        if Player === shooter
          ...
          later 0 do
            bonus.times do
              ...
              when 400...500
                stochastically(50) do
                  drop_item(loc, ItemStack.new(Material::COBBLESTONE, 2))
                end
              when 500...600
                stochastically(25) do
                  drop_item(loc, ItemStack.new(Material::SMOOTH_BRICK, 4))
                end
              when 700...850
                stochastically(25) do
  ...
  def on_player_animation(evt)
    ...
    if @player_swang[player] == :guarding
      ...
      play_sound(player.location, Sound::SUCCESSFUL_HIT, 0.1, 0.0)
      later sec(0.5) do
